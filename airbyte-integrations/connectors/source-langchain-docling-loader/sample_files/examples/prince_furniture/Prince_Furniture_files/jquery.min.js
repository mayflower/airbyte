    ...
    f.each(d, function () {
      c || (e -= parseFloat(f.css(a, "padding" + this)) || 0),
        c === "margin"
          ...
          : (e -= parseFloat(f.css(a, "border" + this + "Width")) || 0);
    });
    return e;
  }
  function bn(a, b) {
  ...
  f.extend({
    ...
    (f.support = (function () {
      ...
      !a.addEventListener &&
        ...
        (j.checkClone = k.cloneNode(!0).cloneNode(!0).lastChild.checked),
        (a.innerHTML = ""),
      ...
      l.appendChild(a),
        ...
        c.defaultView &&
          ...
          (j.reliableMarginRight =
            (parseInt(
              (c.defaultView.getComputedStyle(i, null) || { marginRight: 0 })
                .marginRight,
              10,
            ) || 0) === 0)),
        (l.innerHTML = ""),
      ...
      if (a.attachEvent)
        for (q in { submit: 1, change: 1, focusin: 1 })
          (p = "on" + q),
            (r = p in a),
            r ||
              (a.setAttribute(p, "return;"), (r = typeof a[p] == "function")),
            (j[q + "Bubbles"] = r);
      return j;
    })()),
        ...
        (c = (j && f.attrFix[c]) || c),
          ...
          i ||
            ...
            (typeof d != "boolean" &&
              ...
              ? v && (f.nodeName(a, "form") || u.test(c)) && (i = v)
              : (i = w));
        if (d !== b) {
          if (d === null) {
            f.removeAttr(a, c);
      ...
      if (f.isArray(a)) {
        ...
        if (g && a.length) {
          for (d = 0, e = a.length; d < e; d++)
            (i = a[d]),
              j[i] || (j[i] = U.test(i) ? f(i, b || this.context) : i);
      ...
      function (a, b) {
        f.fn[a] = function (c, d) {
          ...
          P.test(a) || (d = c),
            ...
            (this.length > 1 || R.test(d)) && Q.test(a) && (e = e.reverse());
          ...
          if (typeof k == "string")
            if (!bb.test(k)) k = b.createTextNode(k);
              ...
              !f.support.leadingWhitespace &&
                Z.test(k) &&
                o.insertBefore(b.createTextNode(Z.exec(k)[0]), o.firstChild),
                (k = o.childNodes);
            }
          var r;
          ...
          complete: function (a, b, c) {
            (c = a.responseText),
              a.isResolved() &&
                ...
                i.html(g ? f("<div>").append(c.replace(bO, "")).find(g) : c)),
              d && i.each(d, [c, b, a]);
          },
        });
        return this;
